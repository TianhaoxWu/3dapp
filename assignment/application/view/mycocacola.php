...
<head>
    ...
    <!-- 标题 -->
    <title>Tianhao Wu index page</title>
</head>
<body id="bodyColor">
        ...
        <div class="col-sm-9">
            <div class="card text-left">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">This X3D model of the Sprite bottle has been created in 3ds Max, exported to VRML97 and converted, using the instantreality transcoders, to X3D for display online.</p>
                    <h5 class="card-subtitle">Camera Views</h5>
                    <div class="camera-btns">
                        <p class="card-text">These buttons select a range of X3D model viewpoints</p>
                        <div class="btn-group">
...
<div id="pepper" style="display: none;">
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="card text-left">
                ...
                <!-- Bootstrap 4 card body to hold information about the X3D model-->
                <div class="card-body">
                    <h4 class="card-title">Dr Pepper X3D Model</h4>
                    ...
                    <p class="card-text">This X3D model of the Dr Pepper bottle has been created in 3ds Max, exported to VRML97 and converted, using the instantreality transcoders, to X3D for display online.</p>
                    <h5 class="card-subtitle">Camera Views</h5>
                    <div class="camera-btns">
                        <p class="card-text">These buttons select a range of X3D model viewpoints</p>
                        <div class="btn-group">
    ...
    <!-- Row to hold 1 card to hold the Dr Pepper descriptive text, etc. -->
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Tianhao Wu, Brighton, Email: tw430@sussex.ac.uk</p>
            </div>
